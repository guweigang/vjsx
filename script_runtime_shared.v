...
pub fn is_javascript_file(path string) bool {
	return path.ends_with('.js') || path.ends_with('.mjs') || path.ends_with('.cjs')
}

pub fn is_runtime_module_file(path string) bool {
	return is_typescript_file(path) || is_javascript_file(path)
}
